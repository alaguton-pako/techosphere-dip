<template>
      ...
      <template v-slot:main-content>
        <main class="min-h-screen w-full bg-[#F5F5F5] pl-[260px]">
          <section>
            ...
            <nav
              class="m-10 flex items-center bg-white p-3 font-semibold text-gray-600"
            >
              <div
  ...
  import DepartmentUnit from '@/pages/performance/DepartmentUnit.vue'
  import Overview from '@/pages/performance/Overview.vue'
  import { ref } from "vue";
