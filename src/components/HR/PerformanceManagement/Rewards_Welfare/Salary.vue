      ...
      <main class="w-full bg-[#F5F5F5]">
        <section class="p-12">
          <section class="my-12 flex items-end justify-between">
            <div
              class="flex flex-col pl-20 pr-20 place-content-center rounded border border-gray-700 bg-black py-3 text-white"
            >
              <h2 class="text-xl capitalize">Total Staff</h2>
              <div class="text-[35px] font-bold">102</div>
            </div>
          ...
          <table class="w-full table-auto border border-secondary text-sm">
            ...
            <tbody>
              <tr>
                ...
                <td class="border border-secondary p-3 text-center">Design</td>
                <td class="border border-secondary p-3 text-center">
                  Developer
                </td>
                <td class="border border-secondary p-3 text-center">
                ...
                <td class="border border-secondary p-3 text-center">
                  <div
                    class="pl-3 pr-3 pt-1 pb-1 border border-green-300 text-center text-green-300"
                  >
                    On Payroll
                  </div>
                </td>
                ...
                <td class="border border-secondary p-3 text-center underline">
                  <router-link to="/obligation-reward/account-detail">
                    View</router-link
                  >
                </td>
              </tr>
