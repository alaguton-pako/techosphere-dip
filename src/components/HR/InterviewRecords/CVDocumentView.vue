<template>
  <div class="mx-3 w-full border border-gray-300 p-10">
    <div class="mx-1 my-4 w-full border-gray-400 p-5">
      <div class="grid grid-cols-4 border-b-white bg-gray-200">
        <div class="mb-4">
          <label
            for="name"
            class="text-md text-black-800 mx-2 my-2 mb-2 block font-semibold"
            >Curriculum Vitae/ Resume</label
          >
        </div>
        <div class="flex flex-row">
          ...
          <div class="mb-4 justify-start">
            <label
              for="name"
              class="text-md text-black-800 mx-2 my-2 mb-2 block font-light"
            ></label>
          </div>
        </div>
        ...
        <div class="mb-4">
          <div class="justify-center text-center">
            <button
              class="border-suburbanblack h-[41px] w-[121px] rounded-md border border-solid pb-3.5 pl-7 pr-7 text-center text-black"
            >
              Preview
            </button>
          </div>
      ...
      <div class="grid grid-cols-4 border-b-white">
        <div class="mb-4">
          <label
            for="name"
            class="text-md text-black-800 mx-2 my-2 mb-2 block font-semibold"
            >NYSC Certificate/ Discharge</label
          >
        </div>
        <div class="flex flex-row">
          <div class="my-2 mb-4">
      ...
      <div class="grid grid-cols-4 border-b-white bg-gray-200">
        <div class="mb-4">
          <label
            for="name"
            class="text-md text-black-800 mx-2 my-2 mb-2 block font-semibold"
            >Bachelor's Degree Certificate</label
          >
        </div>
        <div class="flex flex-row">
          <div class="my-2 mb-4">
      ...
      <div class="grid grid-cols-4 border-gray-200">
        <div class="mb-4">
          <label
            for="name"
            class="text-md text-black-800 mx-2 my-2 mb-2 block font-semibold"
            >Post-Graduate Certificate</label
          >
        </div>
        <div class="flex flex-row">
          <div class="my-2 mb-4">
      ...
      <div class="grid grid-cols-4 border-b-white bg-gray-200">
        <div class="mb-4">
          <label
            for="name"
            class="text-md text-black-800 mx-2 my-2 mb-2 block font-semibold"
            >Higher Degree Certificate</label
          >
        </div>
        <div class="flex flex-row">
          <div class="my-2 mb-4">
      ...
      <div class="grid grid-cols-4 border-gray-200">
        <div class="mb-4">
          <label
            for="name"
            class="text-md text-black-800 mx-2 my-2 mb-2 block font-semibold"
            >School Learning Certificate</label
          >
        </div>
        <div class="flex flex-row">
          <div class="my-2 mb-4">
          ...
          <div class="mb-4 justify-start">
            <label
              for="name"
              class="text-md mx-2 my-2 mb-2 block font-light text-transparent"
            ></label>
          </div>
        </div>
