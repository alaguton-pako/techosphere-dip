...
const fetchNetworkFaultById = async () => {
  ...
  if (status === 200) {
    ...
    escalationData.value = data.data.results.data.faultsEscalated;
  }
};
    ...
    <template v-slot:main-content>
      <main class="w-full bg-[#F5F5F5] pl-[260px]">
        ...
        <section class="p-10">
          ...
          <section v-if="fault" class="relative mt-12 border border-secondary">
            <h1
            ...
            <div>
              ...
              >
                ...
                <tbody>
                  <tr
                    class=" "
                    v-for="(item, index) in escalationData"
                    :key="index"
                  >
