<template>
   <section class="pl-4 pr-4 pt-5">
        <form class=" border bg-white shadow-sm pl-6 pt-4 pb-4 pr-6 mt-6 items-center justify-center">
              <nav class="flex justify-between font-semibold text-gray-600">
                <div class="flex items-center">
                  <div class="grid grid-cols-1">
                    <span class="text-xl font-semibold">Operations Department</span>
          ...
          <section class="border border-gray-500 rounded-md pl-16 pt-5 pb-5 pr-16 mt-6">
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: "rgb(255, 	219, 	153)",
        borderColor: 'orange',
        borderWidth: 1
      }, 
      {
