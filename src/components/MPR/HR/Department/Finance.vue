<template>
  <section class="pl-4 pr-4 pt-5">
    <form
      class="mt-6 items-center justify-center border bg-white pb-4 pl-6 pr-6 pt-4 shadow-sm"
    >
      <nav class="flex justify-between font-semibold text-gray-600">
        <div class="flex items-center">
          <div class="grid grid-cols-1">
            <span class="text-xl font-semibold">Financial Department</span>
    ...
    <section class="mt-6 rounded-md border border-gray-500 pb-4 pl-6 pr-6 pt-4">
